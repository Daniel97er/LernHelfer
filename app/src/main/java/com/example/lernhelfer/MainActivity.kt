...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val list1 = listOf("Bezugspreiskalkulation", "Deckungsbeitrag", "Preiselastizitaet", "Tausenderpreis", "Tausenderpreis(Qualitativ)", "Preiselastizitaett")
        ...
        listView1.onItemClickListener = AdapterView.OnItemClickListener { _, _, position, _ ->
            when (position) {
                ...
                5 -> startActivity(Intent(this@MainActivity, PreiselastizitaettActivity::class.java))
